...
* The original package name 'app.nebula.java-worker-demo' is invalid and this project uses 'app.nebula.java_worker_demo' instead.
...
```
$ docker run --rm -p 8080:8080 java-worker-demo:0.0.1-SNAPSHOT
```
